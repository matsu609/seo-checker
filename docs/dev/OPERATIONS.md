...
| サービス | 状態 | 備考 |
|---|---|---|
| GitHub `matsu609/seo-checker` | main = r45 | main に push すると Vercel が自動デプロイ。紹介サイトのソース `marketing/` も同居（09-10 に統合） |
...
>>>>>>> 1985f74 (運用メモを更新（2026-09-13）: Stripe の Price ID の場所と金額の確認)
