...
| サービス | 状態 | 備考 |
|---|---|---|
| GitHub `matsu609/seo-checker` | main = r77 | main に push すると Vercel が自動デプロイ。紹介サイトのソース `marketing/` も同居（09-10 に統合） |
...
### 明日（2026-09-17）リリースするための優先順位（2026-09-16 に整理。利用者の依頼「明日リリースしたい。何を先にやるか」）
