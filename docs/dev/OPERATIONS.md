...
| サービス | 状態 | 備考 |
|---|---|---|
| GitHub `matsu609/seo-checker` | main = r50 | main に push すると Vercel が自動デプロイ。紹介サイトのソース `marketing/` も同居（09-10 に統合） |
...
| 69 | クイック診断（店舗・MEO）にも深さの制限を入れるか（#40 の案 B と同じ考え方。いまは 21 項目すべてと口コミ本文まで無料で出している） | 利用者 → Claude | 判断待ち（サイト側は r50 で代表 10 ページに絞った） |
