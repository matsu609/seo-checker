...
| `SUPABASE_URL` + `SUPABASE_SERVICE_ROLE_KEY` | MEO 診断報告書の「保存」と履歴（Supabase）。未設定なら保存機能を出さない。テーブルは `docs/dev/OPERATIONS.md` の SQL |
