...
運用者と管理アカウントが開ける画面です。お客様からお問い合わせ・クレームが来たとき、この 1 画面で終わるようにしてあります。**どちらの立場でも、登録しているすべてのお客様**が新しい順に並び（2026-09-21 の決定。担当による絞り込みはしません）、1 人ごとに次を確認・操作できます。**管理アカウント自身は顧客ではないので、この一覧には出ません。**
