...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "AI が返信案を作る機能では、利用者本人に表示する下書きを作成する目的に限り、Google から取得した口コミの本文を、運営者が契約する AI 事業者の API に送信します。送信した内容がモデルの学習に使われない設定・契約のもとで利用します（第 6 条）。",
      "連携はいつでも解除できます。本サービスのアカウント設定から Google の接続を外すか、Google アカウントの「セキュリティ」→「サードパーティ製のアプリとサービス」から本サービスのアクセス権を削除してください。解除後、本サービスは新たにデータを取得できなくなります。以前の連携で Search Console・Google アナリティクスの権限を付与していた場合も、本サービスはそれらを読み取りません。",
    ],
    links: [
