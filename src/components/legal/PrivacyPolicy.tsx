...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "AI が分析文や改善案を作る機能（精密診断など）では、利用者本人に表示するレポートを作成する目的に限り、Search Console・Google アナリティクスから取得した集計値を、運営者が契約する AI 事業者の API に送信します。送信した内容がモデルの学習に使われない設定・契約のもとで利用します（第 6 条）。",
