...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "診断のために送信された入力情報と診断結果は、処理のために一時的に扱うだけで、運営者のサーバーには保存しません（一部は応答を速くするため数分〜数時間の一時的なキャッシュに置かれることがあります）。MEO で登録した店舗と、その診断報告書の履歴は、画面からいつでも削除でき、アカウントの削除時にあわせて削除します。店舗の登録を外しても、その店舗の診断報告書の履歴は残りますが、履歴画面から個別に削除できます。",
