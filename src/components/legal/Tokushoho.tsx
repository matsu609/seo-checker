...
export const TOKUSHOHO_ROWS: Row[] = [
  ...
  {
    label: "販売価格",
    value: [...priceRows, "クイック診断（アカウント不要）: 0 円", "割引コード（月額の割引、または初月無料）をお持ちの場合は、申し込み画面で入力すると割引後の金額で決済されます。コードをお持ちでない場合は上記の価格です。コードの発行条件はお問い合わせください。"],
  },
    ...
    value:
      trial > 0
        ...
        : [
            ...
            "初月無料の割引コードをお使いの場合は、お申し込み時はクレジットカードのご登録のみ（初回の請求は 0 円）で、翌月の同じ日から月額をお支払いいただきます。初回の更新日までに解約された場合、料金は発生しません。",
          ],
  },
