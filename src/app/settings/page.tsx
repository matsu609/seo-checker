 ...
 * Google の無料ツールは使わず、検索は「検索パフォーマンス（推定）」で出す）。
 * 口コミ返信に要る Google ビジネス プロフィールの権限は、
 * 口コミ返信の画面から個別に追加する。Search Console の読み取り権限（2026-09-23 に再開）も、
 * SEO の「Google サーチコンソール連携」の画面から個別に追加する。
 */
