...
export const JOB_SCHEDULE: readonly JobSchedule[] = [
  ...
  { id: "monthly-report", label: "月次レポート", description: "前月の数字（順位・MEO・AI 検索・精密診断・掲載・口コミ）をまとめてメールする", cadence: "毎月 1 日", ...monthly(1), minBudgetMs: 60_000 },
  { id: "listings-recheck", label: "掲載の再チェック", description: "掲載済みの媒体のページを開き、店名・電話・住所が今も正しく出ているかを確かめる", cadence: "毎月 2 日", ...monthly(2), minBudgetMs: 60_000 },
