...
export const PLANS: readonly Plan[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "AIO の土台: 日本で効く 7 媒体への基本情報の一括掲載（NAP）。AI 検索モニタリング（ChatGPT / Gemini / Google AI Overviews で自社が引用・参照される割合を毎週計測し、競合と比較）",
      "SEO: HP 改修提案（直すべき箇所を before → after の形で AI が作成）と AI ライティング・エディター",
      "MEO: 口コミ支援（店内 QR のアンケート）、口コミへの AI 返信案、ビジネス プロフィールへの投稿（最新情報）",
