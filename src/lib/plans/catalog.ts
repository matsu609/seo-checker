 ...
 *   free     … クイック診断（サイトと店舗の状態をその場で採点するだけ）。見込み顧客の入口
...
export const PLANS: readonly Plan[] = [
  {
    ...
    label: "クイック診断（無料）",
    priceYen: 0,
    summary: "URL か店名を入れるだけで、いまの状態をその場で採点します。ログイン不要・無料。数値の計測と改修は精密診断（オールインワン）で。",
    highlights: [
      "サイトのクイック診断（1 ページ、またはサイト全体の代表 10 ページ）",
      "店舗のクイック診断（Google マップの店舗 1 件）",
